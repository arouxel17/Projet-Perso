...
function InfoSpot({ spots, deleteSpot, setDisplayModal }) {
  return (
    <div className="bg-primary flex flex-row justify-around my-8 mt-10 pl-4">
            ...
            spots.map((spot) => (
              <tr>
                ...
                <td className="text-center">
                  <button type="button" onClick={() => setDisplayModal(spot)}>
                    <svg
